...
docker exec -i pathology-db psql -U postgres -d pathology_study -f src/db/migrations/005_fix_viewing_attempt_race_condition.sql
```
...
- Fix the viewing_attempt race condition with timestamp-based tracking
